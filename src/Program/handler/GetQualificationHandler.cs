...
namespace Ucu.Poo.TelegramBot
{
    ...
    /// </summary>
    public class GetQualificationHandler : BaseHandler
    {
        public const string PREGUNTAID = "Ingresa el ID del usuario.";
        ...
        public GetQualificationHandler(BaseHandler next):base(next)
        {
            this.Keywords = new string[] {"showqualification"};
        ...
        protected override void InternalHandle(Message message, out string response)
        {
            ...
            {
                var user= UserManager.Instance.Users.Find(i => i.ID == message.From.Id.ToString());
                if(user!=null)
                {
                    this.Data[message.From.Id].UserID= message.Text.ToString();
                    this.Data[message.From.Id].User= user;
                    response= QualificationManager.Instance.getHigherQualification(user).ToString();
