...
public class QualificationTests
{
    ...
    [Test]
    public void MaxQualificationTest()
    {
        UserManager.Instance.CreateUser("Franco", "San Martin", "151515", "employee", "Montevideo", "123456", "test@email.com");
        ...
        int Expected = 5;
        Assert.AreEqual(Expected, UserManager.Instance.Users[0].getMaxQualification());
    }
}